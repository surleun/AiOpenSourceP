...
class PinViewFragment : Fragment() {
    ...
    private fun fetchDummyPinDataById(id: Long): PinItem? {
        val samplePins = listOf(
            PinDTO(201L, 301L, null, 33.2409, 126.5733, "제주사랑", "https://picsum.photos/seed/user301/50"),
            PinDTO(202L, 302L, null, 37.5665, 126.9780, "미식가K", "https://picsum.photos/seed/user302/50")
        )
        return null
    }
