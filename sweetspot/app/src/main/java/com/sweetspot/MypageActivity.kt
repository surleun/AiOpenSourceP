...
class MypageActivity : AppCompatActivity() {
    ...
    private val allSampleData = listOf(
        ...
        PostItem(3L, 2, "다른 사람의 게시물", "타인내용...", "2024-06-03 12:00:00", 20, "타인", null, "https://picsum.photos/seed/otherpost/200", 10, 20),
        ...
        PinItem(203L, 4, "다른 사람의 핀", "타인핀내용...", 37.2, 127.2, "2024-05-12 16:00:00", "타인(핀)", null, "https://picsum.photos/seed/otherpin/200", 3, 5),
        PostItem(4L, 1, "내가 쓴 또 다른 글 (가장 최근)", "내용4...", "2024-06-04 13:00:00", 8, "나", null, "https://picsum.photos/seed/mypost3/200", 8, 15)
    )
    ...
    private fun loadUserProfile() {
        mypageNickname.text = nickname ?: "나의 닉네임 (ID: ${nickname})"

        val imageUrl = profileImageUrl ?: "https://picsum.photos/seed/${nickname}/200"
